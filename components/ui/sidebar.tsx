...
const Sidebar = React.forwardRef<HTMLDivElement, SidebarProps>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("fixed inset-y-0 left-0 z-50 flex w-64 flex-col border-r bg-background", className)}
    {...props}
  />
))
...
const SidebarRail = React.forwardRef<HTMLDivElement, SidebarRailProps>(({ className, ...props }, ref) => (
  <div ref={ref} className={cn("absolute bottom-0 right-0 top-0 w-1 bg-border opacity-50", className)} {...props} />
))
...
export {
  ...
  SidebarSeparator,
  SidebarRail,
  SidebarContent as SidebarContentOld,
  SidebarFooter as SidebarFooterOld,
  SidebarGroup,
  SidebarGroupAction,
  SidebarGroupContent,
  SidebarGroupLabel,
  SidebarHeader as SidebarHeaderOld,
  SidebarInput,
  SidebarInset,
  SidebarMenu as SidebarMenuOld,
  SidebarMenuActionOld as SidebarMenuAction,
  SidebarMenuBadgeOld as SidebarMenuBadge,
  SidebarMenuButtonOld,
  SidebarMenuItemOld,
  SidebarMenuSkeletonOld as SidebarMenuSkeleton,
  SidebarMenuSub,
  SidebarMenuSubButton,
  SidebarMenuSubItem,
  SidebarProvider,
  SidebarRail as SidebarRailOld,
  SidebarSeparator as SidebarSeparatorOld,
  SidebarTrigger,
  useSidebar,
}
